...
namespace Venture.Prefabs 
{
	public class SignIn : MonoBehaviour
	{
		...
		void OnSignIn()
		{
...
#else
			User.Instance.SignIn(() =>
			{
				Game.Instance.Console.Print("Authentication successfull.");
				Document.Instance.Submit();
				Character.Instance.SetupSession();
			});
#endif
			...
			//	Game.Instance.Console.Print("Authentication failed. Please sign in again.");
			//}

//			if (User.Instance.GoogleUser == null)
//			{
...
//					Character.Instance.SetupSession();
//#else
//					Game.Instance.Console.Print("Crashed while signing in.");
//#endif
//				}
//			}
//			else
